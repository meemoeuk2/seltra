...
Method createBlockImage(grey)
 ...
 SetColor 200,50,50
 If bonds2 & %0001 Then DrawRect 0,13,10,3
 If bonds2 & %0010 Then DrawRect 20,13,10,3
 If bonds2 & %0100 Then DrawRect  13,0,3,13
 If bonds2 & %1000 Then DrawRect 13,20,3,13
...
Method createsingleblock:Long(x,y,xv,yv,bonds:Long,btype:Long)
