#include "intmaps.bmx.release.win32.x86.h"
static BBString _s3={
	&bbStringClass,
	12,
...
static int _bb_seltra_intmaps_inited = 0;
int _bb_seltra_intmaps(){
	if (!_bb_seltra_intmaps_inited) {
		_bb_seltra_intmaps_inited = 1;
