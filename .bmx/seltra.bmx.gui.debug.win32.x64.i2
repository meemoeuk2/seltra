...
-fetch||(key||)="_m_seltra_fastlongmap_fetch_y"
-fetch2||(key%)="_m_seltra_fastlongmap_fetch2_i"
-fetchAK||(key%)="_m_seltra_fastlongmap_fetchAK_i"
...
-fastput%(key%,val||,index%)="_m_seltra_fastlongmap_fastput_iyi"
...
blockflags||&=mem:p("_m_seltra_blockflags")
