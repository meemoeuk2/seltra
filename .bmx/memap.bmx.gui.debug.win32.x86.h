#ifndef SELTRA_MEMAP_BMX_GUI_DEBUG_WIN32_X86_H
#define SELTRA_MEMAP_BMX_GUI_DEBUG_WIN32_X86_H
...
typedef BBINT (*_m_memap_fastintmap_vfetch_i_m)(struct _m_memap_fastintmap_obj*,BBINT);
BBINT __m_memap_fastintmap_vfetch_i(struct _m_memap_fastintmap_obj*,BBINT);
typedef BBINT (*_m_memap_fastintmap_kfetch_i_m)(struct _m_memap_fastintmap_obj*,BBINT);
BBINT __m_memap_fastintmap_kfetch_i(struct _m_memap_fastintmap_obj*,BBINT);
...
struct BBClass__m_memap_fastintmap {
	...
	_m_memap_fastintmap_vfetch_i_m m_vfetch_i;
	_m_memap_fastintmap_kfetch_i_m m_kfetch_i;
