#ifndef SELTRA_SELTRA_BMX_GUI_DEBUG_WIN32_X64_H
#define SELTRA_SELTRA_BMX_GUI_DEBUG_WIN32_X64_H
...
struct _m_seltra_btemplate_obj {
	...
	BBINT __m_seltra_btemplate_bonds2;
};
...
typedef BBINT (*_m_seltra_blockarray_putLast_i_m)(struct _m_seltra_blockarray_obj*,BBINT);
BBINT __m_seltra_blockarray_putLast_i(struct _m_seltra_blockarray_obj*,BBINT);
...
typedef BBINT (*_m_seltra_bgroup_addNewBlock_ii_m)(struct _m_seltra_bgroup_obj*,BBINT,BBINT);
BBINT __m_seltra_bgroup_addNewBlock_ii(struct _m_seltra_bgroup_obj*,BBINT,BBINT);
typedef BBINT (*_m_seltra_bgroup_collide_TblockTblock_m)(struct _m_seltra_bgroup_obj*,struct _m_seltra_block_obj*,struct _m_seltra_block_obj*);
BBINT __m_seltra_bgroup_collide_TblockTblock(struct _m_seltra_bgroup_obj*,struct _m_seltra_block_obj*,struct _m_seltra_block_obj*);
typedef BBINT (*_m_seltra_bgroup_collision_manager_TblockTblock_m)(struct _m_seltra_bgroup_obj*,struct _m_seltra_block_obj*,struct _m_seltra_block_obj*);
BBINT __m_seltra_bgroup_collision_manager_TblockTblock(struct _m_seltra_bgroup_obj*,struct _m_seltra_block_obj*,struct _m_seltra_block_obj*);
typedef BBINT (*_m_seltra_bgroup_push_i_m)(struct _m_seltra_bgroup_obj*,BBINT);
BBINT __m_seltra_bgroup_push_i(struct _m_seltra_bgroup_obj*,BBINT);
typedef BBINT (*_m_seltra_bgroup_kicked_m)(struct _m_seltra_bgroup_obj*);
BBINT __m_seltra_bgroup_kicked(struct _m_seltra_bgroup_obj*);
typedef struct _m_seltra_block_obj* (*_m_seltra_bgroup_check_collision_ii_m)(struct _m_seltra_bgroup_obj*,BBINT,BBINT);
struct _m_seltra_block_obj* __m_seltra_bgroup_check_collision_ii(struct _m_seltra_bgroup_obj*,BBINT,BBINT);
...
struct BBClass__m_seltra_bgroup {
	...
	_m_seltra_bgroup_collision_manager_TblockTblock_m m_collision_manager_TblockTblock;
	_m_seltra_bgroup_push_i_m m_push_i;
	_m_seltra_bgroup_kicked_m m_kicked;
	_m_seltra_bgroup_check_collision_ii_m m_check_collision_ii;
...
struct _m_seltra_bgroup_obj {
	...
	BBINT __m_seltra_bgroup_lastmove;
	struct _m_seltra_block_obj* __m_seltra_bgroup_bref;
